...
class AboutInfoCopy extends Component {
	render() {
		return(
			<div className="about__info__copy">
				<p>
					Tavner is a Director of Photography and Camera Operator based in Atlanta. His work has
